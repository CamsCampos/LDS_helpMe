      ...
      <fieldset class="container">
        ...
        <div class="d-flex bd-highlight">
          <div class="p-2 flex-fill bd-highlight">
            <label class="sr-only"
                   for="inline-form-input-name">Nome</label>
            <b-input id="inline-form-input-name"
                     class="mb-2 mr-sm-2 mb-sm-0"
                     v-model="usuario.nome"
                     placeholder="Nome completo:"></b-input>
          </div>
          ...
          <div class="p-2 flex-fill bd-highlight">
            <b-input-group class="mb-3">
              ...
              <b-input-group-append>
                <b-form-datepicker v-model="usuario.data_nascimento"
                                   button-only
                                   right
                                   locale="en-US"
        ...
        <div class="d-flex bd-highlight">
          <div class="p-2 flex-fill bd-highlight">
            <label class="sr-only"
                   for="inline-form-input-user">Name
            </label>
            <b-input id="inline-form-input-user"
                     class="mb-2 mr-sm-2 mb-sm-0"
          ...
          <div class="p-2 flex-fill bd-highlight">
            <b-container fluid>
              <b-row class="my-1"
                     v-for="type in types"
                     :key="type">
                <b-form-input placeholder="Senha"
                              :id="`type-${type}`"
                              :type="type"
        ...
        <div class="d-flex bd-highlight">
          <div class="p-2 flex-fill bd-highlight">
            <div class="my-1"
                 v-for="type in types"
                 :key="type">
              <b-form-input placeholder="Confirmar senha"
                            :id="`type-${type}`"
                            :type="type"
                            v-model="usuario.senhaConfirm">
              </b-form-input>
            </div>
          </div>
          ...
          <div class="p-2 flex-fill bd-highlight">
            <label class="sr-only"
                   for="inline-form-input-email">E-mail </label>
            <b-input id="inline-form-input-email"
                     class="mb-2 mr-sm-2 mb-sm-0"
                     placeholder="E-mail:"
        ...
        <div class="d-flex bd-highlight">
          <div class="p-2 flex-fill bd-highlight">
            <b-form-select v-model="usuario.selectFormacao"
                           :options="usuario.selectOpcoesFormacao"
                           size="sm"
                           class="mt-3">
            </b-form-select>
          </div>
        ...
        <div class="center">
          <b-form-group label="Realizar seu cadastro como:">
            <b-form-radio-group v-model="radioTipoRegistro"
        ...
        <b-row align-h="end"
          ...
          <b-col cols="4">
            <b-button type="submit"
                      ...
                      @click.prevent="salvar">Cadastrar</b-button>
          </b-col>
  ...
  export default {
    data() {
      return {
        usuario: {
          nome: "Calhau",
          email: "lucas.noman@sga.pucminas.br",
          data_nascimento: "1996-05-24",
          descricao: "",
          formacao: "Ensino Médio",
          // formacao: this.selectFormacao,
          nome_usuario: "lucasnoman",
          senha: "123456",
          senhaConfirm: "",
