  ...
  <div id="app"  class="grad" >
    ...
    <form action="submit">
      <fieldset class="container">
        ...
        <!-- Dropdown de escolaridade -->
        <div class="d-flex bd-highlight">
          <div class="p-2 flex-fill bd-highlight">
            <b-form-select
              v-model="dropDownScholarity"
              :options="dropDownScholariryOprions"
              size="sm"
              class="mt-3"
            ></b-form-select>
        ...
        <div class="center">
          <b-form-group label="Realizar seu cadastro como:">
            <b-form-radio-group
              v-model="radioRegisterType"
              :options="radioRegisterOptions"
              class="mb-3"
              value-field="item"
              text-field="name"
...
-->
      ...
      <div class="container-fluid">
        <b-row align-h="end espaco">
          <b-col cols="4">
            <b-button type="submit" variant="primary center"
              >Cadastrar</b-button
            >
          </b-col>
...
export default {
  data() {
    return {
      dropDownScholarity: null,
      dropDownScholariryOprions: [
